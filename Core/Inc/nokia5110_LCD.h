 ...
 */
typedef struct {
	struct LCD_GPIO gpio;
	struct LCD_att att;
} lcd_handler;

/*----- Library Functions -----*/
void LCD_send(lcd_handler *my_lcd_handler, uint8_t val);
void LCD_write(lcd_handler *my_lcd_handler, uint8_t data, uint8_t mode);
...
void LCD_invert(lcd_handler *my_lcd_handler, bool mode);
void LCD_invertText(lcd_handler *my_lcd_handler, bool mode);
void LCD_putChar(lcd_handler *my_lcd_handler, char c);
void LCD_print(lcd_handler *my_lcd_handler, char *str, uint8_t x, uint8_t y);
void LCD_clrScr(lcd_handler *my_lcd_handler);
void LCD_goXY(lcd_handler *my_lcd_handler, uint8_t x, uint8_t y);
 ...
 */
void LCD_refreshScr(lcd_handler *my_lcd_handler);
void LCD_refreshArea(lcd_handler *my_lcd_handler, uint8_t xmin, uint8_t ymin,
		uint8_t xmax, uint8_t ymax);
void LCD_setPixel(lcd_handler *my_lcd_handler, uint8_t x, uint8_t y, bool pixel);
void LCD_drawHLine(lcd_handler *my_lcd_handler, int x, int y, int l);
void LCD_drawVLine(lcd_handler *my_lcd_handler, int x, int y, int l);
void LCD_drawLine(lcd_handler *my_lcd_handler, int x1, int y1, int x2, int y2);
void LCD_drawRectangle(lcd_handler *my_lcd_handler, uint8_t x1, uint8_t y1,
